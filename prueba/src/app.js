...
app.use('/api/products', productsRouter) 
  //Con esta linea estamos utilizando los endpoints creados en el archivos users.js y le estamos dando una ruta la cual es /api/users, la cual fue creada hasta este punto y en los endpoints que estan fuera solo les pusimos la raiz, de igual forma podemos agregarles rutas en los endpoints externos las cuales deberan de agregarse despues de este para llegar al endpoint requerido
